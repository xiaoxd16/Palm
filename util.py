...
def transfrom_format(a,shape):
	output = []
	output.append(a[4])
	output.append(float(a[0] + a[2]) / 2.0 / shape)
	output.append(float(a[1]+ a[3]) / 2.0 / shape)
	output.append(float(a[2]-a[0])/shape)
	output.append(float(a[3]-a[1])/shape)
	return output